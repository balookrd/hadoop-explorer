...
run_hdfs() {
  echo "=========================================="
  echo "🧪 Запуск тестов: HDFS Explorer (29 тестов)"
  echo "=========================================="
  local pt
  pt="$(find_pytest hdfs)"
...
run_sql() {
  echo "=========================================="
  echo "🧪 Запуск тестов: SQL Explorer (28 тестов)"
  echo "=========================================="
  local pt
  pt="$(find_pytest sql)"
...
run_yarn() {
  echo "=========================================="
  echo "🧪 Запуск тестов: YARN Explorer (41 тест)"
  echo "=========================================="
  local pt
  pt="$(find_pytest yarn)"
...
case "$APP" in
  ...
  all)
    ...
    echo ""
    echo "========================================================"
    echo "🎉 ВСЕ 98 ТЕСТОВ ПЛАТФОРМЫ HADOOP EXPLORER ПРОЙДЕНЫ УСПЕШНО!"
    echo "========================================================"
    ;;
  *)
